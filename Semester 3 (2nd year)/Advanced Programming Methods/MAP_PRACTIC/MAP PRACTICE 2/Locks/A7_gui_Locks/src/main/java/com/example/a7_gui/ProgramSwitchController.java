    ...
    private void displayProgram(ActionEvent event)
    {
        ...
        else
        {
            ...
            try{
                ...
                ProgramState prg = new ProgramState(new MyStack<>(), new MySymbolTable<>(), new MyList<Value>(), new MyFileTable<>(), new MyHeap(),new MyLockTable(), selectedStatement);
...
//        );
        ...
        IStatement prg10 = new CompoundStatement(new VariableDeclarationStatement("v1", new RefType(new IntType())),
                                ...
                                new CompoundStatement(new VariableDeclarationStatement("q", new IntType()),
                                        new CompoundStatement(new NewStatement("v1", new ValueExpression(new IntValue(20))),
                                                new CompoundStatement(new NewStatement("v2", new ValueExpression(new IntValue(30))),
                                                        new CompoundStatement(new CreateLockStatement("x"),
                                                                new CompoundStatement(new ForkStatement(
                                                                        new CompoundStatement(new ForkStatement(
                                                                        ...
                                                                        new CompoundStatement( new CreateLockStatement("q"),
                                                                                new CompoundStatement(new ForkStatement(
                                                                                        new CompoundStatement( new ForkStatement(
