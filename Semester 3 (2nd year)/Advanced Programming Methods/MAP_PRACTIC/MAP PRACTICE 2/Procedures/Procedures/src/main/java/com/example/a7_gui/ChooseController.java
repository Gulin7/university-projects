...
public class ChooseController {
    ...
    private void displayProgram(ActionEvent event)
    {
        ...
        else
        {
            ...
            try{
                ...
                IRepository repo = new Repository(prg, "C:\\Users\\gulin\\OneDrive\\Desktop\\MAP\\MAP PRACTICE 2\\MAP PRACTICE 2\\Procedures");
    ...
    private ObservableList<IStatement> getAllPrograms()
    {
        ...
        IStatement prg5 = new CompoundStatement(new VariableDeclarationStatement("varf", new StringType()),
                new CompoundStatement(new AssignStatement("varf", new ValueExpression(new StringValue("C:\\Users\\gulin\\OneDrive\\Desktop\\MAP\\MAP PRACTICE 2\\MAP PRACTICE 2\\Procedures"))),
