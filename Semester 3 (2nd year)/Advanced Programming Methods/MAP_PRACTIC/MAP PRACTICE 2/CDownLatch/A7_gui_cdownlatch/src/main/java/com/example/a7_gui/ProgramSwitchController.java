...
public class ProgramSwitchController {
    ...
    private void displayProgram(ActionEvent event)
    {
        ...
        else
        {
            ...
            try{
                ...
                ProgramState prg = new ProgramState(new MyStack<>(), new MyDictionary<>(), new MyList<Value>(), new MyDictionary<>(), new MyHeap(),new MyCountdownLatchTable(), selectedStatement);
                IRepository repo = new Repository(prg, "C:\\Users\\gulin\\OneDrive\\Desktop\\MAP\\MAP PRACTICE 2\\MAP PRACTICE 2\\CDownLatch\\A7_gui\\src\\main\\java\\com\\example\\a7_gui\\logFile" + (id+1) + ".txt");
    ...
    private ObservableList<IStatement> getAllPrograms()
    {
        ...
        IStatement prg5 = new CompoundStatement(new VariableDeclarationStatement("varf", new StringType()),
                new CompoundStatement(new AssignStatement("varf", new ValueExpression(new StringValue("C:\\Users\\gulin\\OneDrive\\Desktop\\MAP\\MAP PRACTICE 2\\MAP PRACTICE 2\\CDownLatch\\A7_gui\\src\\main\\java\\com\\example\\a7_gui\\test.in"))),
...
//        );
        ...
        /// CondAssign
        IStatement prg11 = new CompoundStatement(new VariableDeclarationStatement("a", new RefType(new IntType())),
                new CompoundStatement(new VariableDeclarationStatement("b", new RefType(new IntType())),
                        new CompoundStatement(new VariableDeclarationStatement("v", new IntType()),
                                new CompoundStatement(new HeapAllocationStmt("a", new ValueExpression(new IntValue(0))),
                                        new CompoundStatement(new HeapAllocationStmt("b", new ValueExpression(new IntValue(0))),
                                                        ...
                                                        new CompoundStatement(new WriteHeapStatement("b", new ValueExpression(new IntValue(2))),
                                                                new CompoundStatement(new CondAssignStatement(
                                                                        ...
                                                                        new CompoundStatement(new PrintStatement(new VariableExpression("v")), new CompoundStatement(
                                                                                new CondAssignStatement( new RelationalExpression(">", new ArithmeticExpression('-', new ReadHeapExpression(new VariableExpression("b")), new ValueExpression(new IntValue(2))), new ReadHeapExpression(new VariableExpression("a"))),
                                                                                        new ValueExpression(new IntValue(100)), new ValueExpression(new IntValue(200)),"v"),
                                                                                new PrintStatement(new VariableExpression("v"))
