package View;// Press Shift twice to open the Search Everywhere dialog and type `show whitespaces`,
...
//                                new PrintStmt(new ReadHeapExp(new ReadHeapExp( new VarExp("a")))))))));
        IStmt ex8 = new CompStmt(new VarDeclStmt("a", new RefType(new IntType())),
                new CompStmt(new VarDeclStmt("count", new IntType()),
                        new WhileStmt(
                            new RelationalExp(new VarExp("count"),"<", new ValueExp(new IntValue(10))),
                            new CompStmt(new ForkStmt(new ForkStmt(new NewStmt("a", new VarExp("count")))), new AssignStmt("count", new ArithExp('+', new VarExp("count"), new ValueExp(new
                                    IntValue(1))))))));
