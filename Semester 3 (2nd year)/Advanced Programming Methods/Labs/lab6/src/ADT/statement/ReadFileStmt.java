...
//        }
    ...
    public MyIDictionary<String, Type> typecheck(MyIDictionary<String, Type> typeEnv) throws MyException {
        ...
        if(!typeVar.equals(new IntType())){
            throw new MyException("READ FILE " + var_name + "it's not of type int");
        }
        Type typeExp = exp_file_name.typecheck(typeEnv);
        if (typeExp.equals(new StringType()))
            return typeEnv;
        else
            throw new MyException("READ FILE " + exp_file_name + "it's not of type string");
